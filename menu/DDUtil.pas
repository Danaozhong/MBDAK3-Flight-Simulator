...
{ Contributor(s)                                                   }
{ --------------                                                   }
{ Alexey Barkovoy ( clootie@reactor.ru )                           }
{                                                                  }
{ Obtained through:                                                }
...
{   2002-12-09 - Alexey Barkovoy - Bug fixes                       }
{                                                                  }
{                                                                  }
{******************************************************************}
interface
...
begin
  ...
  FWidth:= m_ddsd.dwWidth;
  FHeight:= m_ddsd.dwHeight;
  FRGBMode := GetRGBMode;
...
begin
  ...
  if (@pdwShift = nil) or (@pdwBits = nil) then
  begin
    result := E_INVALIDARG;
    exit;
  end;

  if (@dwBitMask <> nil) then
  begin
