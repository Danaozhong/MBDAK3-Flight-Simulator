...
//-----------------------------------------------------------------------------
function D3DUtil_SetDeviceCursor(pd3dDevice: IDirect3DDevice8; hCursor: HCURSOR): HRESULT;
...
type
  ...
  CD3DArcBall = class
    ...
    m_fRadius2: Single;                    // ArcBall's radius in screen coords
...
const
  ...
  m_vDown: TD3DXVector3 = (x:0; y:0; z:0);         // Button down quaternion
  m_vCur: TD3DXVector3  = (x:0; y:0; z:0);         // Current quaternion
{$WRITEABLECONST OFF}
var
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          D3DXQuaternionMultiply(m_qNow, m_qDown,
            D3DXQuaternion(vPart.x, vPart.y, vPart.z, D3DXVec3Dot(m_vDown, vCur)));
        end;
      ...
      begin
        ...
        fDeltaX:= (iCurMouseX - iMouseX) * m_fRadius2 / m_iWidth;
        fDeltaY:= (iCurMouseY - iMouseY) * m_fRadius2 / m_iHeight;
