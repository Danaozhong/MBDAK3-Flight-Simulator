...
function D3DXLoadMeshFromX(const pFilename : PAnsiChar; const Options : LongWord;
  const pD3D : IDirect3DDevice8; out ppAdjacency, ppMaterials : ID3DXBuffer;
  out pNumMaterials : LongWord; out ppMesh: ID3DXMesh): HResult; stdcall; external d3dx8dll;
...
function D3DXLoadMeshFromX(pFilename: PAnsiChar; Options: DWord;
  ...
  pNumMaterials: Cardinal; out ppMesh: ID3DXMesh): HResult; stdcall; external d3dx8dll;
{$EXTERNALSYM D3DXLoadMeshFromX}
                     *)
